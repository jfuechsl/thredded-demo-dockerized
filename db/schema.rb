...
ActiveRecord::Schema.define(version: 20170510185425) do
  ...
  create_table "thredded_post_moderation_records", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.index ["messageboard_id", "created_at"], name: "moderation_records_for_display", order: { created_at: :desc }
  ...
  create_table "thredded_topics", force: :cascade do |t|
    ...
    t.index ["moderation_state", "sticky", "updated_at"], name: "topics_for_display", order: { sticky: :desc, updated_at: :desc }
  ...
  create_table "thredded_user_details", force: :cascade do |t|
    ...
    t.index ["moderation_state", "moderation_state_changed_at"], name: "user_details_for_moderations", order: { moderation_state_changed_at: :desc }
